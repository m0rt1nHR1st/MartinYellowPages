// MartinYellowPages - simple YellowPages GUI using Java Swing components



import java.awt.*; //Standard library which contains classes to create windows, buttons, textfields and so on...(these classes are simple wrappers to the platform's GUI objects
...
class PhoneInfo implements Serializable //How to implement a Searchable as Java supports multiple interface inheritance ?
{
	String name;
	String phoneNumber;
...
class MartinYellowPagesManager
{
	private final File dataFile = new File("MartinYellowPages.dat");
	HashSet<PhoneInfo> infoStorage = new HashSet<PhoneInfo>();
	
	static MartinYellowPagesManager inst = null;
	public static MartinYellowPagesManager createManagerInst()
	{
		if(inst == null)
			inst = new MartinYellowPagesManager();
		return inst;
	}
	
	private MartinYellowPagesManager()
	{
		readFromFile();
	}
...
class SearchEventHandler implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		MartinYellowPagesManager manager= MartinYellowPagesManager.createManagerInst();
...
class MainFrame extends JFrame
{
	...
	JButton srchBtn = new JButton("SEARCH"); //An implementation of a "push" button
	
	JButton addBtn = new JButton("ADD");
	JRadioButton rbtn1 = new JRadioButton("General");//An implementation of a "radio" visualized tick button
	...
	public MainFrame(String title)
	{
		...
		Border srchBorder = BorderFactory.createTitledBorder(border, "Search MYP contacts");
		...
		Border addBorder=BorderFactory.createTitledBorder(border, "Add NEW MYP contact");
		...
		Border delBorder = BorderFactory.createTitledBorder(border, "Remove MYP contact");
		...
		Border textBorder=BorderFactory.createTitledBorder(border, "Events Board");
...
class MartinYellowPages
{	
	public static void main(String[] args)
	{
		MartinYellowPagesManager manager = MartinYellowPagesManager.createManagerInst();
		MainFrame winFrame = new MainFrame("MartinYellowPages®");
	}
}
